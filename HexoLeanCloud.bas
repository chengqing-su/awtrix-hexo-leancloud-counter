...
Public Sub Initialize() As String
	...
	App.description = $"
	This an app to show hexo leancloud counter
	"$
	
	'The developer if this App
	App.author = "Chengqing Su"
